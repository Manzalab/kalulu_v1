(function () {
    ...
    function Fx (game) {
        ...
        this.success_background_01 = this.success.create(0, 0, 'common/src/fx', 'FX_01');
        ...
        this.success_background_02 = this.success.create(0, 0, 'common/src/fx', 'FX_02');
        ...
        this.success_particles.makeParticles('common/src/fx', 'FX_03');
        ...
        this.fail_background_01 = this.fail.create(0, 0, 'common/src/fx', 'FX_04');
        ...
        this.fail_background_02 = this.fail.create(0, 0, 'common/src/fx', 'FX_05');
        ...
        this.fail_particles.makeParticles('common/src/fx', 'FX_06');
