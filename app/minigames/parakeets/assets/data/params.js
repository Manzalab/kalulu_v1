    ...
    return {
        baseConfig : { // the "baseConfig" settings are a base to all difficulty levels, overriden by the level specific values.
            ...
            localRemediation : { // the local remediation settings are used to adapt the difficulty inside a game. The game divide the min-max range in 5 stages and starts at the middle one.
                ...
                alternativePercentage           : {min : 0, max : 0},
                alternativePicturePercentage    : {min : 0, max : 0}
            }
        },
        levels: [ // the settings for difficulty levels 1 to 5
            ...
            { // LEVEL 2
                ...
                localRemediation : {
                    showTime                        : {min : 3, max : 2}, //
                    alternativePercentage           : {min : 0, max : 0.2},
                    alternativePicturePercentage    : {min : 1, max : 0.8}
                }
            },
            { // LEVEL 3
                globalRemediation : {
                ...
                localRemediation : {
                    ...
                    alternativePercentage           : {min : 0.2, max : 0.5},
                    alternativePicturePercentage    : {min : 1, max : 0.6}
                }
            }, 
            { // LEVEL 4
                globalRemediation : {
                ...
                localRemediation : {
                    ...
                    alternativePercentage           : {min : 0.5, max : 0.7},
                    alternativePicturePercentage    : {min : 0.6, max : 0.4}
                }
            },
            { // LEVEL 5
                globalRemediation : {
                ...
                localRemediation : {
                    showTime                        : {min : 1.5, max : 1}, //
                    alternativePercentage           : {min : 0.7, max : 0.8},
                    alternativePicturePercentage    : {min : 0.4, max : 0.2}
                }
            }
        ]
    };
