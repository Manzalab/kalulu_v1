...
var Recognition = function(number, stimuli_type, gameType, numbers_available, count,  numbers_data, lang){
	...
	var st =  this.moduleutils.addStimuli(true , this.number, 'number',numbers_data, Lpath, lang)
