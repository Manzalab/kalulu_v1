(function () {
    ...
    **/
    function LoadingManager (eventSystem) {
        ...
        AuthoritativeSystem.call(this, eventSystem, 'LoadingManager');
    ...
    LoadingManager.prototype = Object.create(AuthoritativeSystem.prototype);
    ...
    Object.defineProperties(LoadingManager.prototype, {
    ...
    **/
    ...
    LoadingManager.prototype._onLoadCompleted = function _onLoadCompleted (loader) {
        ...
        {
            if (lMainUI.key==null)  lMainUI[key] = lToyChestUI[key];
